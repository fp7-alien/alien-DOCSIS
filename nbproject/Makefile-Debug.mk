...
${OBJECTDIR}/src/extensions/cof_queue_prop_src_port.o: src/extensions/cof_queue_prop_src_port.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/extensions/cof_queue_prop_src_port.o src/extensions/cof_queue_prop_src_port.cpp

${OBJECTDIR}/src/extensions/cofmsg_set_queues.o: src/extensions/cofmsg_set_queues.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/extensions
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/extensions/cofmsg_set_queues.o src/extensions/cofmsg_set_queues.cpp
