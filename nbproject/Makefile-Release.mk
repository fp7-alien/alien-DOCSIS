...
${OBJECTDIR}/src/DOCSIS/CMTS/CMTS_handler.o: src/DOCSIS/CMTS/CMTS_handler.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libconfig++` -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DOCSIS/CMTS/CMTS_handler.o src/DOCSIS/CMTS/CMTS_handler.cpp

${OBJECTDIR}/src/DOCSIS/DOCSISdriver.o: src/DOCSIS/DOCSISdriver.c++ 
	${MKDIR} -p ${OBJECTDIR}/src/DOCSIS
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libconfig++` -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DOCSIS/DOCSISdriver.o src/DOCSIS/DOCSISdriver.c++

${OBJECTDIR}/src/QoS/QoS.o: src/QoS/QoS.c++ 
	${MKDIR} -p ${OBJECTDIR}/src/QoS
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libconfig++` -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/QoS/QoS.o src/QoS/QoS.c++
...
${OBJECTDIR}/src/main.o: src/main.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libconfig++` -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp

${OBJECTDIR}/src/orchestrator/Flowcache.o: src/orchestrator/Flowcache.c++ 
	${MKDIR} -p ${OBJECTDIR}/src/orchestrator
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libconfig++` -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/orchestrator/Flowcache.o src/orchestrator/Flowcache.c++

${OBJECTDIR}/src/orchestrator/orchestrator.o: src/orchestrator/orchestrator.c++ 
	${MKDIR} -p ${OBJECTDIR}/src/orchestrator
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libconfig++` -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/orchestrator/orchestrator.o src/orchestrator/orchestrator.c++

${OBJECTDIR}/src/proxy/ALHINP.o: src/proxy/ALHINP.c++ 
	${MKDIR} -p ${OBJECTDIR}/src/proxy
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libconfig++` -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/proxy/ALHINP.o src/proxy/ALHINP.c++

${OBJECTDIR}/src/translator/translator.o: src/translator/translator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/translator
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags libconfig++` -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/translator/translator.o src/translator/translator.cpp
